...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("log_statistical_tests_by_category.log")
    ...
    logger.info(f"Normality test for FID (SD) Big Mask: {sd_big_normality}, details: {sd_big_normality_details}")
